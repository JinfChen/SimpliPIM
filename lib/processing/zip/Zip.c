...
void table_zip(const char* src1_name, const char* src2_name, const char* dest_name, uint32_t outputs, handle_t* binary_handle, smalltable_management_t* table_management){
